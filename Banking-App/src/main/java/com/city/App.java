...
public class App {
	...
	public static void main(String[] args) throws SQLException {
		...
		do {
			...
			System.out.println("7. Update Loan Account: ");
			System.out.println("8. delete loan account: ");
			...
			case 5:
				...
				break;
			case 6:
				List<Loan> list2 = loanRepository.displayAllLoans();
				for (Loan r : list2) {
			...
			case 7:
				...
				loanRepository.updateLoanByLoanId(id);
				break;
			case 8:
				System.out.println("Enter Loan ID: ");
				int i=scanner.nextInt();
				loanRepository.deleteLoanAccountById(i);
				break;
			case 0:
				System.exit(0);
